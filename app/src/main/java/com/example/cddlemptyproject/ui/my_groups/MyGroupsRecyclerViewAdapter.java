...
public class MyGroupsRecyclerViewAdapter extends RecyclerView.Adapter<MyGroupsRecyclerViewAdapter.ViewHolder> {
    ...
    private MyGroupsRecyclerViewAdapter.ItemClickListener mClickListener;


    // data is passed into the constructor
    MyGroupsRecyclerViewAdapter(Context context, List<Group> data) {
    ...
    @Override
    public MyGroupsRecyclerViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.rv_list_item, parent, false);
        return new MyGroupsRecyclerViewAdapter.ViewHolder(view);
    }

    // binds the data to the TextView in each row
    @Override
    public void onBindViewHolder(MyGroupsRecyclerViewAdapter.ViewHolder holder, int position) {
    ...
    void setClickListener(MyGroupsRecyclerViewAdapter.ItemClickListener itemClickListener) {
